...
import { userCreatedPostsQuery, userQuery, userSavedPostsQuery } from '../utils/userData';
import { useNavigate, useParams } from 'react-router-dom';
import HashLoader from "react-spinners/HashLoader";



const activeBtnStyles = 'bg-red-600 text-white font-bold p-2 rounded-full w-20 outline-none';
...
export const UserProfile = () => {
  ...
  if (!user) return <div className='flex justify-center items-center h-screen'><HashLoader color="#dc2626" /></div>;
